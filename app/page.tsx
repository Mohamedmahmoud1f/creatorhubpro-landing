...
<div class="hero-tagline en-text" style="display:none">
        ...
        <p class="hero-v2-sub ar-text">
                      نظام متكامل يجمع بين <strong>المونتاج الاحترافي</strong> و<strong> التحليل والخطة والأفكار
            لحد كتابة الإسكربت والتصميم ومتابعة النتائج</strong>
        ...
        <div class="package-card package-featured animate-on-scroll">
          ...
          <div class="pkg-usp-block">
            ...
            <ul class="pkg-features pkg-features-usp ar-text">
              <li><i class="fas fa-star"></i> <span>بث مباشر ودورات تعليمية مع خبراء صناعة المحتوى</span></li>
              <li><i class="fas fa-star"></i> <span>جلسات استشارية منتظمة إسبوعية لتطوير المحتوى</span></li>
